...
const AboutPage = () => {
  const teamMembers = [
    ...
    },
    {
      ...
      bio: 'David leads our customer service team, ensuring every customer is completely satisfied.',
    },
  ];
  ...
  return (
    <div className="pt-16">
      ...
      <section className="bg-gradient-to-r from-blue-600 to-blue-400 text-white py-16 md:py-24">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">About Laundry Hub</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-4">
                Laundry Hub was founded in 2020 with a simple mission: to provide busy professionals, families, and businesses with high-quality laundry services that save time and deliver exceptional results.
              </p>
              <p className="text-gray-600 mb-4">
            ...
            <div className="bg-gray-200 h-80 rounded-lg flex items-center justify-center">
              <p className="text-gray-600">Laundry Hub Story Image Placeholder</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              These core values guide everything we do at Laundry Hub.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="order-2 lg:order-1 bg-gray-200 h-80 rounded-lg flex items-center justify-center">
              <p className="text-gray-600">Why Choose Us Image Placeholder</p>
            </div>
            <div className="order-1 lg:order-2">
              <h2 className="text-3xl font-bold mb-6">Why Choose Laundry Hub?</h2>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              The dedicated professionals behind Laundry Hub's exceptional service.
            </p>
          </div>
      ...
      {/* CTA Section */}
      <CTASection 
        title="Experience the Laundry Hub Difference"
